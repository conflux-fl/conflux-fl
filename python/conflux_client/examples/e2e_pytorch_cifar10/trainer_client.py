#!/usr/bin/env python3
"""Real-training test-harness client — same structure as the MNIST
demo's trainer_client.py, using a real PyTorch CNN and CIFAR-10 shard
instead. See that file's own docstring for the shared design notes
(omniscient shard loading, round-polling loop, poison mode).
"""
