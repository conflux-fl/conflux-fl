#!/usr/bin/env python3
"""Trains the same CNN on the pooled (non-federated) CIFAR-10
subsample, with the same total gradient-step budget the federated run
uses — the correctness bar the federated run is compared against."""
