...
def run_one(
    ...
    if attack == "poison":
        ...
        # separation is the whole point of the comparison — see the E2E
        # harnesses guide's "Real findings" (https://confluxfl.dev/guides/e2e-harnesses/)
        # on the reputation filter masking aggregator differences.
