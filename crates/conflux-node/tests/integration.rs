...
//! `stub_client.py`) lives in the shared harness under `baselines/`,
//! driven by `conflux-baselines` — spawning arbitrary external processes
//! inside `cargo test` isn't hermetic or standard practice.
