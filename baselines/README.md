...
|---|---|---|---|---|---|
| [`bulyan-elmhamdi-2018`](bulyan-elmhamdi-2018/) | [El Mhamdi et al. (ICML 2018)](https://proceedings.mlr.press/v80/mhamdi18a.html) | `bulyan` | python, rust | 1 attacker(s), reputation filter off | python 0.91 ± 0.05 · rust 0.91 ± 0.05 |
